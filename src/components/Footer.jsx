...
const Footer = () => {
  return (
    <footer className="bg-[#000000] text-white  py-10 px-[70px]">
      {/* Top Container */}
      <div className="flex justify-between w-full border-b border-gray-600 pb-8 ">
        {/* Left Section */}
        <div className="w-1/2">
        ...
        {/* Right Section */}
        <div className="w-1/2 ml-[100px]  text-left space-y-2">
          <p className="text-lg font-normal text-[20px] font-[inter]">
            CONTACT US
          </p>
          <p className="text-sm font-normal font-[inter]">+44 221 133 5360</p>
          ...
          <p className="text-sm font-normal font-[inter]">USD</p>
          <p className="text-sm font-normal font-[inter]">
      ...
      {/* Middle Container */}
      <div className="flex justify-between border-b border-gray-600 py-8">
        {/* Left Section */}
        <div className="w-1/3">
